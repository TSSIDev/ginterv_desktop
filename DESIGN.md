...
| `--accent-solid` (fondo bottoni) | `oklch(60% 0.17 285)` | `oklch(54% 0.19 285)` |
...
Testo dark: `--text-1 95%`, `--text-2 72%`, `--text-3 56%`. Light: `28%`, `46%`, `58%`.
Bordi dark: `--border 30%`, `--border-2 40%`. Light: `--border 90.5%`, `--border-2 84%`.

### Semantici
`--green` 155h, `--amber` 80h, `--red` 28h. Dark più chiari (L~74%), light più scuri (L~50%) per contrasto.
